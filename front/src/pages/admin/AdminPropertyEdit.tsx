...
export default function AdminPropertyEdit() {
  ...
  useEffect(() => {
    ...
    api
      .get(`/documents?propertyId=${id}`)
      .then((r) => r.ok && setDocuments(r.data));
  }, [id]);
  ...
  const handleAddDoc = async (e: FormEvent) => {
    e.preventDefault();
    if (!tenantId) {
      setError("Assignez un locataire avant d'ajouter des documents");
      return;
    }
  ...
  return (
    <div className={styles.page}>
      ...
      <p className={styles.subtitle}>
        ...
        &middot; {property.price.toLocaleString()} &euro;
      </p>
