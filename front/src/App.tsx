      ...
      <Routes>
        ...
        <Route element={<RequireAuth />}>
          <Route element={<ClientLayout />}>
            ...
            <Route path="/espace-client/documents" element={<ClientDocuments />} />
            <Route path="/espace-client/tickets" element={<ClientTickets />} />
            <Route path="/espace-client/tickets/nouveau" element={<ClientTicketNew />} />
            <Route path="/espace-client/tickets/:id" element={<ClientTicketDetail />} />
          </Route>
        </Route>
        ...
        <Route element={<RequireRole roles={['EMPLOYEE', 'ADMINISTRATOR']} />}>
          <Route element={<AdminLayout />}>
            ...
            <Route path="/admin/properties/:id" element={<AdminPropertyEdit />} />
