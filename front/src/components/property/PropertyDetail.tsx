    ...
    <div className={styles.detail}>
      ...
      <div className={`container ${styles.content}`}>
        <div className={styles.main}>
          ...
          <div className={styles.tags}>
            <Badge variant="accent">
              {property.type === "achat" ? "Achat" : "Location"}
            </Badge>
            <Badge variant="accent">
              {property.kind === "appartement" ? "Appartement" : "Maison"}
            </Badge>
          ...
          <div className={styles.quickMeta}>
            <span>
              <Maximize2 size={15} /> {property.surface} m²
            </span>
            <span>
              <Home size={15} /> {property.rooms} pièces
            </span>
            <span>
            ...
            {property.floor !== undefined && (
              <span>
                <ArrowUpDown size={15} />{" "}
                {property.floor === 0 ? "RDC" : `${property.floor}e étage`}
              </span>
            )}
          </div>
          ...
          <div className={styles.section}>
            ...
            <div className={styles.specGrid}>
              ...
              <div className={styles.specItem}>
                <span className={styles.specLabel}>
                  <Accessibility size={14} /> Accessible PMR
                </span>
                <span className={styles.specValue}>
                  {property.accessiblePMR ? "Oui" : "Non"}
                </span>
              </div>
              <div className={styles.specItem}>
                <span className={styles.specLabel}>
              ...
              <div className={styles.specItem}>
                <span className={styles.specLabel}>
                  <Train size={14} /> Transports
                </span>
                <span className={styles.specValue}>
                  {property.proximiteTransports}
                </span>
              </div>
            </div>
          </div>
              ...
              <div className={styles.section}>
                ...
                <div className={styles.specGrid}>
                  <div className={styles.specItem}>
                    ...
                    <span className={styles.specValue}>
                      {property.chargesIncluded} €/mois
                    </span>
                  </div>
                  <div className={styles.specItem}>
                    <span className={styles.specLabel}>Hors charges</span>
                    <span className={styles.specValue}>
                      {property.chargesExcluded} €/mois
                    </span>
                  </div>
                </div>
              </div>
        ...
        <div className={styles.sidebar}>
          ...
          <div className={styles.refBlock}>Réf. {property.ref}</div>
        </div>
      </div>
    </div>
  );
